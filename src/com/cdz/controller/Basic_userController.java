...
public class Basic_userController extends CDZBaseController {
	...
	/*
	 * public void listHandler(HttpModel httpModel) { Dto qDto =
	 * httpModel.getInDto(); List<Dto> list = sqlDao.list("Basic_user.listHandler",
	 * httpModel.getInDto()); httpModel.setOutMsg(AOSJson.toGridJson(list)); }
	 */
