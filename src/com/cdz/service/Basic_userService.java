...
public class Basic_userService extends CDZBaseController {
	...
	public void listHandler(HttpModel httpModel) {
		/* Dto qDto = ; */
		List<Dto> list = sqlDao.list("Basic_user.listHandler", httpModel.getInDto());
	...
	/*
	 * public void listComboBoxData2(HttpServletRequest request, HttpServletResponse
	 * response) { Dto inDto = Dtos.newDto(request); List<Dto> list =
	 * sqlDao.list("Demo.listComboBoxData", inDto); WebCxt.write(response,
	 * AOSJson.toJson(list)); }
	 */
	/*
	 * public void listHandler2(HttpServletRequest request, HttpServletResponse
	 * response) { // Dto qDto = httpModel.getInDto(); Dto inDto =
	 * httpModel.getInDto(); List<Dto> list = sqlDao.list("Basic_user.listHandler2",
	 * inDto); WebCxt.write(response, AOSJson.toJson(list)); }
	 */
	/*
	 * public void listComboBoxData2(HttpServletRequest request, HttpServletResponse
	 * response) { Dto inDto = Dtos.newDto(); List<Dto> list =
	 * sqlDao.list("Demo.listComboBoxData", inDto); WebCxt.write(response,
	 * AOSJson.toJson(list)); }
	 */
	/**
