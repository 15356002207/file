	...
	<aos:viewport layout="fit">
		<aos:gridpanel id="_g_role" url="roleService.listRole" onrender="_g_role_query" forceFit="true"
			...
			<%-- <aos:menu>
				...
				<aos:menuitem text="修" onclick="_w_role_u_show" icon="" />
				<aos:menuitem text="删除" onclick="_g_role_del" icon="" />
			...
			<aos:docked forceBoder="0 0 1 0">
				...
				<aos:dockeditem onclick="_w_role_u_show" text="修" icon="edit.png" />
			...
			<aos:column header="授" rendererFn="_btn_grant_render" align="center" width="100" />
	 	...
	 	function _role_user_cancel(){
          ...
          //按钮列转换
        	...
        	function fn_button_del(value, metaData, record) {
        		return '<input type="button" value="删" class="cbtn" onclick="fn_del();" />';
        	}
        </script>
</aos:onready>
