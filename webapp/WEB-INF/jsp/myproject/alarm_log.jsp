	...
	<aos:viewport layout="fit">
		<aos:gridpanel id="_datagridpanel" url="alarm_logService.listAlarm_log" onrender="_datagridpanel_query" onitemdblclick="_w_update_show"  forceFit="false">
			...
			<aos:selmodel type="checkbox" mode="multi" />
						      			       ...
						      			       <aos:column header="报警序号" dataIndex="alarm_id"   width="90" />
			    						      			       <aos:column header="设备id" dataIndex="device_id"   width="100" />
			    						      			       <aos:column header="用户手机号" dataIndex="user_phone"   width="100" />
			    						      			       <aos:column header="报警时间" dataIndex="alarm_time"   width="150" />
			    						      			       <aos:column header="出警时间" dataIndex="response_time"   width="150" />
			    						      			       <aos:column header="报警方式" dataIndex="type_"   width="70" />
			    						      			       <aos:column header="处理者" dataIndex="handler_"   width="70" />
			    						      			       <aos:column header="处理者电话" dataIndex="handler_phone"   width="100" />
			    						      			       <aos:column header="报警原因" dataIndex="reason_"   width="70" />
			    						      			       <aos:column header="报警解除" dataIndex="alarm_release"   width="70" />
			    						      			       <aos:column header="取消报警" dataIndex="is_cancel"   width="70" />
	...
	<aos:window id="_w_add_data" title="新增报警日志" width="600"   height="400"  autoScroll="true">
		<aos:formpanel id="_f_add"  width="600-20"     layout="anchor" labelWidth="70">
         	   	       	        <aos:textfield name="alarm_id" fieldLabel="报警序号"   allowBlank="false"   maxLength="255"    	         />
	      	   	 	         	      	    ...
	      	   	 	         	      	    <aos:datetimefield name="alarm_time" fieldLabel="报警时间"   	               editable="true"/>
	  	 	         	      	    <aos:datetimefield name="response_time" fieldLabel="出警时间"   	                  editable="true"/>
