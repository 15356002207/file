...
<aos:onready>
	...
	<aos:window id="_w_update_data" title="修改设备" resizable="true" maximized="true"   height="480"   layout="fit" modal="true" center="true" maximizable="true" closable="false" >
		...
		<aos:formpanel id="_f_update"  layout="column" autoScroll="true" labelWidth="100">
          <%-- <aos:hiddenfield name="id_"/> --%>
			...
			<%-- 	<aos:checkboxgroup  name="hhh1" fieldLabel="周一" maxLength="700" /> --%>
                <aos:textfield name="hhh2" fieldLabel="周二" maxLength="700" />
